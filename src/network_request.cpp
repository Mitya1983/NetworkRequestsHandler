...
void tristan::network::NetworkRequest::setPriority(tristan::network::Priority priority) { m_priority = priority; }
...
void tristan::network::NetworkRequest::setResponseDelimiter(std::vector< uint8_t > delimiter) { m_delimiter = std::move(delimiter); }
...
void tristan::network::NetworkRequest::cancel() { ProtectedMembers::pSetStatus(*this, tristan::network::Status::CANCELED); }

void tristan::network::NetworkRequest::pauseProcessing() { ProtectedMembers::pSetStatus(*this, tristan::network::Status::PAUSED); }

void tristan::network::NetworkRequest::continueProcessing() { ProtectedMembers::pSetStatus(*this, tristan::network::Status::RESUMED); }
...
auto tristan::network::NetworkRequest::status() const noexcept -> tristan::network::Status { return m_status; }

auto tristan::network::NetworkRequest::isPaused() const noexcept -> bool { return m_paused.load(std::memory_order_relaxed); }

auto tristan::network::NetworkRequest::isCanceled() const noexcept -> bool { return m_canceled.load(std::memory_order_relaxed); }

auto tristan::network::NetworkRequest::priority() const noexcept -> tristan::network::Priority { return m_priority; }
...
auto tristan::network::NetworkRequest::responseDelimiter() const noexcept -> const std::vector< uint8_t >& { return m_delimiter; }

auto tristan::network::NetworkRequest::requestData() -> const std::vector< uint8_t >& { return m_request_data; }

void tristan::network::NetworkRequest::setRequest(std::vector< uint8_t >&& request_data) { m_request_data = std::move(request_data); }
...
void tristan::network::NetworkRequest::addPausedCallback(std::function< void() >&& functor) { m_paused_void_functors.emplace_back(std::move(functor)); }
...
void tristan::network::NetworkRequest::addResumedCallback(std::function< void() >&& functor) { m_resumed_void_functors.emplace_back(std::move(functor)); }
...
void tristan::network::NetworkRequest::addCanceledCallback(std::function< void() >&& functor) { m_canceled_void_functors.emplace_back(std::move(functor)); }
...
void tristan::network::NetworkRequest::addFailedCallback(std::function< void(const std::string&) >&& functor) {
...
void tristan::network::NetworkRequest::addFailedCallback(std::function< void(const std::string&, std::error_code) >&& functor) {
...
void tristan::network::NetworkRequest::ProtectedMembers::pSetStatus(std::shared_ptr< NetworkRequest > network_request, Status status) {
...
void tristan::network::NetworkRequest::ProtectedMembers::pSetError(std::shared_ptr< NetworkRequest > network_request, std::error_code error_code) {
